...
//=>  • Nomes personalizados para pads (35 nomes pré-definidos )                           <=
...
const char name_19[] PROGMEM = "SPLASH 2   ";
const char name_20[] PROGMEM = "STACK      ";
const char name_21[] PROGMEM = "GOWBELL    ";
const char name_22[] PROGMEM = "PANDEROLA  ";
const char name_23[] PROGMEM = "CAIXA REVB ";
const char name_24[] PROGMEM = "CAIXA 2    ";
const char name_25[] PROGMEM = "TIMBALE    ";
const char name_26[] PROGMEM = "SPLASH 2   ";
const char name_27[] PROGMEM = "ROTONTOM 1 ";
const char name_28[] PROGMEM = "ROTONTOM 2 ";
const char name_29[] PROGMEM = "BUMBO 2    ";
const char name_30[] PROGMEM = "PAD EFET 2 ";
const char name_31[] PROGMEM = "PAD EFET 3 ";
const char name_32[] PROGMEM = "PAD EFET 4 ";
const char name_33[] PROGMEM = "PAD EFET 5 ";
const char name_34[] PROGMEM = "PAD EFET 6 ";
...
const char* const available_names[NUM_AVAILABLE_NAMES] PROGMEM = {
  ...
  name_20, name_21, name_22, name_23, name_24, name_25, name_26, name_27, name_28, name_29,
