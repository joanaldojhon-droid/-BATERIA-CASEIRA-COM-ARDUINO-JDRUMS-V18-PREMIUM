...
const char name_18[] PROGMEM = "CON CHIMBAL";
const char name_19[] PROGMEM = "CHIMBAL    ";
...
const char name_27[] PROGMEM = "CAIXA      ";
const char name_28[] PROGMEM = "ARO CAIXA  ";
const char name_29[] PROGMEM = "BUMBO      ";
const char name_30[] PROGMEM = "GOMBELL    ";
