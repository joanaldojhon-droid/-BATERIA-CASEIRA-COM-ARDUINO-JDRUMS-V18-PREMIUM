...
const char name_19[] PROGMEM = "CRASH 1    ";
const char name_20[] PROGMEM = "CRASH 2    ";
const char name_21[] PROGMEM = "CRASH 3    ";
const char name_22[] PROGMEM = "GOMBELL    ";
...
const char name_29[] PROGMEM = "CON CHIMBAL";
const char name_30[] PROGMEM = "CHIMBAL    ";
