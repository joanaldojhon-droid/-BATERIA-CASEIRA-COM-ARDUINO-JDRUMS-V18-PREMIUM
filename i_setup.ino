...
void setup()
{
  ...
  // *** XCanCost por pad é carregado por LoadXCanCostEEPROM() dentro de LoadAllEEPROM() ***
  // *** EEPROM virgem: mantém valores do PAD_PRESETS (set() em c_pin.ino) ***
