...
void LoadAllEEPROM()
{
  ...
  if(Version==41)  // *** v41: inclui AntiCrosstalk (param 0x0F) no load/save ***
  {
    LoadGeneralEEPROM(0);
    LoadGeneralEEPROM(2);
    LoadGeneralEEPROM(3);
    
    // *** CORRECAO BUG A8/A9 PERSONA - PASSO 1 ***
    // Carrega notas Persona ANTES de LoadAdvancedEEPROM(11),
    // pois LoadAdvancedEEPROM(11) chama applyVSTPreset(PERSONA)
    // que usa VST_NOTES_PERSONA[]. Se ainda tiver defaults, as notas ficam erradas.
    loadPersonaNotes();
    ...
    LoadChokeFilterEEPROM();  // *** NOVO: Filtro Choke ***
    
    // *** CORRECAO BUG A8/A9 PERSONA - PASSO 2 ***
    // Reaplicar preset APOS todo LoadEEPROM para sincronizar Pin[i].Note
    // com as notas corretas do preset ativo. O LoadEEPROM(i, NOTE) pode ter
    // sobrescrito Pin[i].Note com valor salvo de outro preset.
  ...
  else
  {
    ...
    // *** NOVO: Inicializa Persona pela primeira vez ***
    loadPersonaNotes();
    
    // *** NOVO: Grava padrões dos Pads Digitais e Chokes na primeira inicialização ***
    SaveDigitalNotesEEPROM();  // Grava {84,85,86,87,88,89,90} nos endereços 526-532
    SaveChokeNotesEEPROM();    // Grava {78,80,82,63} nos endereços 533-536
...
void SaveAdvancedEEPROM(byte Param)
{
  ...
  switch(Param)
  {
    ...
    case 11: Value=currentVSTPreset; break;
...
void LoadAdvancedEEPROM(byte Param)
{
  ...
  switch(Param)
  {
    case 0: paramCode = ENABLE_37_38_TO_40; break;
    case 1: paramCode = ENABLE_VEL_FILTER; break;
    case 2: paramCode = ENABLE_RIMSHOT; break;
    case 3: paramCode = ENABLE_101_TO_102; break;
    case 4: paramCode = ENABLE_103_TO_104; break;
    case 5: paramCode = BLOCK_WINDOW; break;
    case 6: paramCode = VEL_THRESHOLD_37_38; break;
    case 7: paramCode = DETECTION_WINDOW; break;
    ...
    case 11: paramCode = VST_PRESET; break;
...
void SaveNameEEPROM(byte pin)
{
  #if defined(__AVR__)
  if(pin < 16) {
    if(selected_names[pin] >= NUM_AVAILABLE_NAMES || selected_names[pin] > 24) {
