...
const byte ANTICROSSTALK = 0x0F;  // *** CRÍTICO: Define parâmetro 15 ***
const byte VEL_MINIMO    = 0x10;  // *** Piso de velocity individual por porta (0-60) ***

const byte ENABLE_37_38_TO_40    = 0x10;
const byte ENABLE_VEL_FILTER     = 0x11;
const byte ENABLE_RIMSHOT        = 0x12;
const byte ENABLE_101_TO_102     = 0x13;
const byte ENABLE_103_TO_104     = 0x14;
const byte BLOCK_WINDOW          = 0x15;
const byte VEL_THRESHOLD_37_38   = 0x16;
const byte DETECTION_WINDOW      = 0x17;
...
byte GetPinSetting(byte pin, byte Set)
{
  ...
  switch(Set)
  {
    ...
    #endif
      break;
    case ANTICROSSTALK:  // *** CRÍTICO: Retorna AntiCrosstalk ***
      Value=Pin[pin].AntiCrosstalk;
      break;
    case VEL_MINIMO:
...
void SendAdvancedSetting(byte Set)
{
  ...
  switch(Set)
  {
    ...
    case 0x7F:
      simpleSysex(0x02,0x7D,ENABLE_37_38_TO_40,ENABLE_NOTE_37_38_TO_40);
      simpleSysex(0x02,0x7D,ENABLE_VEL_FILTER,ENABLE_VELOCITY_FILTER);
      simpleSysex(0x02,0x7D,ENABLE_RIMSHOT,ENABLE_RIMSHOT_38_TO_40);
      simpleSysex(0x02,0x7D,ENABLE_101_TO_102,ENABLE_NOTE_101_TO_102);
      simpleSysex(0x02,0x7D,ENABLE_103_TO_104,ENABLE_NOTE_103_TO_104);
      simpleSysex(0x02,0x7D,BLOCK_WINDOW,(byte)(BLOCK_WINDOW_MS/10));
      simpleSysex(0x02,0x7D,VEL_THRESHOLD_37_38,VELOCITY_THRESHOLD_37_38);
      simpleSysex(0x02,0x7D,DETECTION_WINDOW,(byte)DETECTION_WINDOW_MS);
      ...
      simpleSysex(0x02,0x7D,VST_PRESET,currentVSTPreset);
  ...
  switch(Cmd)
  {
    ...
    case 0x03:
      ...
      else if(Data1==0x7D)
      {
        switch(Data2)
        {
          case ENABLE_37_38_TO_40: ENABLE_NOTE_37_38_TO_40=Data3; markAdvancedChanged(); break;
          case ENABLE_VEL_FILTER: ENABLE_VELOCITY_FILTER=Data3; markAdvancedChanged(); break;
          case ENABLE_RIMSHOT: ENABLE_RIMSHOT_38_TO_40=Data3; markAdvancedChanged(); break;
          case ENABLE_101_TO_102: ENABLE_NOTE_101_TO_102=Data3; markAdvancedChanged(); break;
          case ENABLE_103_TO_104: ENABLE_NOTE_103_TO_104=Data3; markAdvancedChanged(); break;
          case BLOCK_WINDOW: BLOCK_WINDOW_MS=(unsigned long)Data3*10; markAdvancedChanged(); break;
          case VEL_THRESHOLD_37_38: VELOCITY_THRESHOLD_37_38=Data3; markAdvancedChanged(); break;
          case DETECTION_WINDOW: DETECTION_WINDOW_MS=(unsigned long)Data3; markAdvancedChanged(); break;
          ...
          case VST_PRESET: applyVSTPreset(Data3); break;
          // *** NOVO: Controle saídas MIDI ***
      ...
      else
      {
        if(Data1 < 16) {
          switch(Data2)
          {
            ...
            #endif
            case ANTICROSSTALK: Pin[Data1].AntiCrosstalk=Data3; markPinChanged(Data1); break;  // *** CRÍTICO ***
