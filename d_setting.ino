...
const byte ANTICROSSTALK = 0x0F;  // AntiCrosstalk local por pad (mantém código 0x0F para compatibilidade EEPROM)
...
byte GetPinSetting(byte pin, byte Set)
{
  ...
  switch(Set)
  {
    ...
    #endif
      break;
    case ANTICROSSTALK: // AntiCrosstalk local por pad
      ...
      else
      {
        if(Data1 < 16) {
          switch(Data2)
          {
            ...
            #endif
            case ANTICROSSTALK: Pin[Data1].AntiCrosstalk=Data3; markPinChanged(Data1); break;
