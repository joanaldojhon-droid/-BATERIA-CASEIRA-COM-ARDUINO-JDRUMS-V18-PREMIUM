...
const char name_15[] PROGMEM = "PAD EFEIT 1 ";
const char name_16[] PROGMEM = "PAD EFEIT 2";
const char name_17[] PROGMEM = "PAD EFEIT 3";
const char name_18[] PROGMEM = "CHINA      ";
const char name_19[] PROGMEM = "SPLASH     ";
const char name_20[] PROGMEM = "CAIXA REVEB";
const char name_21[] PROGMEM = "GOWBELL    ";
const char name_22[] PROGMEM = "PANDEROLA  ";
const char name_23[] PROGMEM = "ROTONTOM 1 ";
const char name_24[] PROGMEM = "ROTONTOM 2 ";
