...
void Up()
{
  ...
  else if(eMenuSelect==2)
  {
    ...
    else if(eMenuPage>=2 && eMenuPage<18)
    {
      ...
      {
        case 0: // Note
          // A0(0)=Controlador, A1(1)=Chimbal, A2(2)=Baixo — nota protegida; A3(3)=Caixa liberada
          if(pinIndex >= 3) {
            ADD(Note);
            // *** MODIFICAÇÃO 3: se mudou nota do A3, atualiza CUSTOM_NOTE_37 no buffer ***
            if(pinIndex == 3) {
...
void Down()
{
  ...
  else if(eMenuSelect==1) 
  {
    ...
    // *** MENU TIMING (página 35) — navega entre os 3 parâmetros para trás ***
      ...
      if(eMenuPin==18 && eMenuPage!=4) eMenuPin=14;
      if(eMenuPin==17 && eMenuPage!=4) eMenuPin=14;
      if(eMenuPin==16 && eMenuPage!=4) eMenuPin=14;
      // InvSensor (15): só A0 (page==2)
