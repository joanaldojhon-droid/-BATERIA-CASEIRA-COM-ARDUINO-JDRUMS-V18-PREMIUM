...
void Up()
{
  ...
  else if(eMenuSelect==1)
  {
    if(eMenuPage==0) Mode=(mode)(((int)Mode+1)%4);
      ...
      if(eMenuProMicroParam == 10) eMenuProMicroParam = 11;  // pula Anticros (oculto)
    }
...
void Down()
{
  ...
  else if(eMenuSelect==1) 
  {
    if(eMenuPage==0) Mode=(mode)((int)Mode-1>-1?(int)Mode-1:3);
      ...
      if(eMenuProMicroParam == 10) eMenuProMicroParam = 9;  // pula Anticros (oculto)
    }
  ...
  // *** Menu Pads Auxiliar (24) ***
    ...
    switch(eMenuProMicroParam) {
      ...
      case 9:
        ...
        break;
      // case 10 (Anticros/XtackCancel) oculto — não aparece no menu visual
      case 11:
