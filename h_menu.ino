...
void Menu()
{
  ...
  if (btnB == LOW && btnA == LOW) {
    ...
    // *** [DESATIVADO] Atalho A+B para edição de nome no menu principal ***
    // else if(eMenuPage >= 2 && eMenuPage < 18 && eMenuPin == 14) { ... }
    else if(eMenuPage >= 2 && eMenuPage < 18 && eMenuPin == 14) {
      // Atalho desativado — A+B não acessa edição de nome
      return;
    }
    // *** PADS AUXILIAR (página 24, parâmetro NAME=11, nível 2): A+B 1.5s → edita nome ***
    // *** [DESATIVADO] Atalho A+B para edição de nome nos Pads Auxiliar ***
    ...
    // *** [DESATIVADO] Atalho A+B para edição de nome dos presets ***
    // else if(eMenuPage == 20 && eMenuSelect == 1 && eMenuBackup >= 0 && eMenuBackup <= 2) { ... }
    else if(eMenuPage == 20 && eMenuSelect == 1 && eMenuBackup >= 0 && eMenuBackup <= 2) {
      // Atalho desativado — A+B não acessa edição de nome do preset
...
void Up()
{
  ...
  else if(eMenuSelect==1)
  {
    ...
    else if(eMenuPage==28) eMenuChokeNote=(eMenuChokeNote+1)%4;  // *** NOVO: Página 28 - Notas Choke ***
  ...
  else if(eMenuSelect==2)
  {
    ...
    else if(eMenuPage>=2 && eMenuPage<18)
    {
      ...
      switch(eMenuPin)
      {
        ...
        case 11: // VeMinimo — incrementa 0-100 com wrap
          {
...
void Down()
{
  ...
  else if(eMenuSelect==1) 
  {
    ...
    else if(eMenuPage==28) eMenuChokeNote=eMenuChokeNote-1>-1?eMenuChokeNote-1:3;  // *** NOVO: Página 28 ***
  ...
  else if(eMenuSelect==2) 
  {
    ...
    else if(eMenuPage>=2 && eMenuPage<18) 
    {
      ...
      switch(eMenuPin) 
      {
        ...
        case 11: // VeMinimo — decrementa 0-100 com wrap
          {
            byte vm = Pin[pinIndex].VelMinimo;
...
void Draw()
{
  ...
  // *** NOVO: Notas Choke (28) - mostra nota ***
  else if(eMenuPage==28) {
