  ...
  else if(eMenuSelect==2)
  {
    ...
    else if(eMenuPage>=2 && eMenuPage<18)
    {
      ...
      switch(eMenuPin)
      {
        ...
        case 7: if(Pin[eMenuPage-2].XCanCost < 127) { Pin[eMenuPage-2].XCanCost++; markPinChanged(eMenuPage-2); } break;
  ...
  else if(eMenuSelect==2) 
  {
    ...
    else if(eMenuPage>=2 && eMenuPage<18) 
    {
      ...
      switch(eMenuPin) 
      {
        ...
        case 7: if(Pin[eMenuPage-2].XCanCost > 0) { Pin[eMenuPage-2].XCanCost--; markPinChanged(eMenuPage-2); } break;
        case 8: break;  // Xtalk removido — não faz nada
        case 9: break;  // alias removido — não faz nada
